...
class Reader(object):
    def __init__(self, dataset_dir, listfile=None):
        ...
        self._listfile_header = self._data[0] # get the header
        self._data = self._data[1:] # get the lines
        # print("self._listfile_header: ", self._listfile_header)
...
class InvasiveVentilationReader(Reader):
    def __init__(self, dataset_dir, listfile=None):
